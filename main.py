...
class InterfaceUpdater():
    ...
    def update_board (self, board_num):
        for ipg in self.boardManager.Borards[board_num].IPGs:
            if ipg.is_stimulating() and ipg.is_communicating():
                self.change_IPG_color_GREEN(board.idNum, ipg.idNum)
            elif not ipg.is_stimulating() and ipg.is_communicating():
                self.change_IPG_color_RED(board.idNum, ipg.idNum)
            else:
                self.change_IPG_color_GRAY(board.idNum, ipg.idNum)
